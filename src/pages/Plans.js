    ...
    <div>
      ...
      <div className="inscription-container">
        ...
        <div className="process">
          <div id="flowBoxes">
            <div class="right active">Entrevista Inicial</div>
            <div class="left right ">Definir Fecha de Inicio</div>
            <div class="left right">Seguimiento Constante</div>
            <div class="left actives">Agenda tu Entrevista</div>
          </div>
        </div>
      </div>
    </div>
